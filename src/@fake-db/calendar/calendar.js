...
export const events = [
  ...
  // Work
  {
    ...
    start: moment()
      ...
      .second(0)
      .millisecond(0)
      .toISOString(), // 19th of the current month at 15:00
    end: moment()
      .date(19)
      .hour(17)
      .minute(30)
      .second(0)
      .millisecond(0)
      .toISOString(), // 19th of the current month at 17:30
    duration: null,
    allDay: true,
    recurrence: null,
    type: "work",
  },
  {
    ...
    start: moment()
      ...
      .second(0)
      .millisecond(0)
      .toISOString(), // 8th of the current month at 11:30
    end: moment()
      .date(8)
      .hour(12)
      .minute(45)
      .second(0)
      .millisecond(0)
      .toISOString(), // 8th of the current month at 12:45
    duration: null,
    allDay: false,
    recurrence: null,
    type: "work",
